...
public class SwaggerCodegen {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(SwaggerCodegen.class);
    private static final String GENERATE_COMMAND_NAME = "Generate";
    ...
    public static void main(String[] args) {
                ...
                if (StringUtils.isNotBlank(language)) {
                    ...
                    if (codegenArguments != null && !codegenArguments.isEmpty()) {
                        for (CodegenArgument codegenArgument : codegenArguments) {
                            ...
                            Class clazz = "boolean".equalsIgnoreCase(codegenArgument.getType()) ?
        ...
        try {
            ...
            if (commandObject instanceof Runnable) {
                new Thread(((Runnable) commandObject)).run();
            }
